    ...
    <aside class="app-sidebar verde shadow">
      ...
      <div class="sidebar-brand">
        ...
        <a href="../index.php" class="brand-link">
          ...
          <!--end::Brand Image-->
          <!--begin::Brand Text-->
          <span class="title"><img src="../media/senalibrary icon.png"
              style="width:30px; height:40px; vertical-align:middle; margin-right:5px; margin-top: 5px; margin-bottom: 5px;">
            SenaLibrary</span>
          <!--end::Brand Text-->
        </a>
        <!--end::Brand Link-->
                  ...
                  <?php while ($fila = $resultado->fetch_assoc()): ?>
                    <tr>
                      ...
                      <td>
                        ...
                        <span
                          class="badge d-inline-flex align-items-center gap-1 px-3 py-2 rounded-pill <?php echo $badgeClass; ?>">
          ...
          if (res.success) {
            let tabla = `
             ...
             res.detalle.forEach(item => {
                    // Procesar categorias (puede venir como array o string separado por comas)
                    let categorias = '';
